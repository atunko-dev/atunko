...
Discover and search OpenRewrite recipes available on the project classpath.
...
### Requirement: CORE_0001.1
The system SHALL implement CORE_0001.1.

#### Scenario: SVC_CORE_0001.1
The system SHALL pass SVC_CORE_0001.1.
